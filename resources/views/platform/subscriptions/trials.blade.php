                    ...
                    <table class="min-w-full divide-y divide-line text-sm">
                        <thead class="bg-surface-muted/50 text-ink-muted">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 text-left font-medium">{{ __('Created') }}</th>
                        ...
                        <tbody class="divide-y divide-line">
                            @foreach ($organizations as $organization)
                                <tr class="hover:bg-surface-muted/60">
                                    ...
                                    <td class="px-4 py-3 text-ink-muted">{{ $organization->created_at->format('M j, Y') }}</td>
                                    <td class="px-4 py-3">
