<nav class="mb-6 flex flex-wrap gap-3 text-sm border-b border-line pb-3">
    ...
    <a href="{{ route('ess.attendance.index') }}" class="{{ request()->routeIs('ess.attendance.*') ? 'font-semibold text-primary-700' : 'text-ink-muted hover:text-ink-heading' }}">{{ __('Attendance') }}</a>
