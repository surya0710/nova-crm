# Konnect Nex Enterprise Presentation

## Deliverables

| File | Description |
|------|-------------|
| `KonnectNex_Presentation.pptx` | Editable 23-slide 16:9 enterprise deck (project root + `presentation/`) |
| `KonnectNex_Presentation.pdf` | PDF export of the full deck |
