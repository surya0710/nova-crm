...
/**
 * Enterprise demo dataset for NovaCRM presentation screenshots.
 *
...
class PresentationDemoSeeder extends Seeder
{
    ...
    private function employeeRoster(): array
    {
        ...
        return [
            ...
            ['code' => 'NE-002', 'first_name' => 'Priya', 'last_name' => 'Sharma', 'dept' => 'ENG', 'designation' => 'ENG-02', 'email' => 'priya.sharma@novaenterprises.test', 'user_email' => 'priya.sharma@novacrm.test', 'role' => 'project-manager', 'gender' => 'female', 'dob' => "{$year}-07-05", 'joining_date' => '2018-06-15', 'mobile' => '+91 98765 43211', 'address' => '22 Bandra West', 'is_head' => true],
            ...
            ['code' => 'NE-008', 'first_name' => 'Kavita', 'last_name' => 'Nair', 'dept' => 'SAL', 'designation' => 'SAL-01', 'email' => 'kavita.nair@novaenterprises.test', 'user_email' => 'amit.verma@novacrm.test', 'role' => 'sales-manager', 'gender' => 'female', 'dob' => '1985-08-19', 'joining_date' => '2017-05-22', 'mobile' => '+91 98765 43220', 'is_head' => true],
            ...
            ['code' => 'NE-012', 'first_name' => 'Neha', 'last_name' => 'Gupta', 'dept' => 'HR', 'designation' => 'HR-01', 'email' => 'neha.gupta@novaenterprises.test', 'user_email' => 'neha.gupta@novacrm.test', 'role' => 'hr', 'gender' => 'female', 'dob' => '1987-02-28', 'joining_date' => '2016-08-01', 'mobile' => '+91 98765 43230', 'is_head' => true],
    ...
    private function seedCrmData(): void
    {
        ...
        $products = [];
        foreach ([
            ['name' => 'NovaCRM Enterprise License', 'sku' => 'NOVA-CRM-ENT', 'type' => 'service', 'price' => 149999],
        ...
        $invoice = Invoice::query()->updateOrCreate(
            ...
            [
                ...
                'title' => 'NovaCRM Enterprise — Year 1',
