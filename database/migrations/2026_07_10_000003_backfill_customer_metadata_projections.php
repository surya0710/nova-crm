...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('metadata_value_projections') || ! Schema::hasTable('customers')) {
            return;
        }
        ...
        Organization::withoutGlobalScopes()
            ->pluck('id')
            ->each(fn (int $organizationId) => $projection->rebuildForOrganizationEntity($organizationId, 'customer'));
    }
