...
| Projects | Projects, milestones, tasks, portfolios, programs, risks, resources |
| HRMS | Employees, attendance, leave, recruitment, performance, payroll foundations, assets |
| Marketing | Campaigns, providers, attribution, ROI signals |
| Analytics | Executive and module analytics, KPI library, AI insights |
...
4. Extensible API and workflow foundations

## Next step
Book a tailored demo · Start a pilot · Review security overview