...
class StoreAttendanceOvertimeRuleRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('manageRules', AttendanceOvertimeRule::class) ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('attendance_overtime_rules', 'code')->where('organization_id', $org?->id),
            ],
