...
class CreatePerformanceReviewTemplateRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('create', PerformanceReviewTemplate::class) ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => [
                ...
                Rule::unique('performance_review_templates', 'code')->where('organization_id', $org?->id),
            ],
