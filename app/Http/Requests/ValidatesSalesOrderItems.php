...
trait ValidatesSalesOrderItems
{
    /**
     * @return array<string, mixed>
     */
    protected function salesOrderFieldRules(bool $isUpdate = false): array
    {
        ...
        $rules = [
            ...
            'currency' => ['required', 'string', Rule::in(array_keys(config('sales_orders.currencies')))],
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            try {
                app(SalesOrderCalculationService::class)->validateItems($items);
