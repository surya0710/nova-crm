...
class CreateJobRequisitionRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('create', JobRequisition::class) ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'target_joining_date' => ['nullable', 'date', 'after_or_equal:today'],
